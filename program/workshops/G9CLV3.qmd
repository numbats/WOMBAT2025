...
title: 'In conversation: Rob Hyndman &amp; Nick Tierney on Research Software, hosted by
  Cynthia Huang'
description: The session explores the roles of research software engineering, open
  source software, and reproducibility in the context of statistical software development.
  Key topics include the definition and significance of these terms, unique challenges
  in creating statistical software and R packages, and how software design and open
  source packages enhance the accessibility and dissemination of data-driven research.
speaker:
- code: FLUHHT
